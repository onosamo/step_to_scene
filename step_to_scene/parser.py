...
class StepAssembly:
    ...
    def __init__(
        ...
        name: str,
        id: str,
        parent: Optional["StepAssembly"] = None,
        description: str = "",
        ...
        self.product_name = product_name or name  # PRODUCT name for shape lookup
    ...
    def get_absolute_transform(
        ...
        def multiply_transforms(parent_pos, parent_rot, child_pos, child_rot):
            ...
            r11 * c12 + r12 * c22 + r13 * c32
            r11 * c13 + r12 * c23 + r13 * c33
...
class StepParser:
    ...
    def __init__(self, filepath: Path):
        ...
        self.unit_scale = (
            1.0  # Scale factor to convert to meters (1.0 = meters, 0.001 = mm)
        )
    ...
    def _extract_assemblies(self, entities: dict[str, str]):
        ...
        for entity_id, entity_data in entities.items():
            ...
            # Note: XCAF uses the second parameter as the name
            if entity_data.startswith("PRODUCT("):
                ...
                if len(quoted_strings) >= 3:
                    ...
                    name = quoted_strings[1]  # Use second parameter
